  ...
  return (
    <div className="container flex mx-auto px-4 py-12">
      <div className="w-1/2 p-4">
        ...
        <p className="mb-6">I graduated from NUS with a BSc (Honours) in Business Analytics, double major in Statistics and have been working in the finance industry as a GenAI and backend developer. My interest lies in leveraging Generative AI to solve business pain points. 
